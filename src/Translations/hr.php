...
return [
    ...
    // Header / Nav
    'nav.menu' => 'Izbornik',
    'nav.open_menu' => 'Otvori izbornik',
    'nav.home' => 'Početna',
    'nav.about' => 'O nama',
    'nav.contact' => 'Kontakt',
    'nav.write_us' => 'Pišite nam',
    ...
    'products.more' => 'Više o proizvodu',
    'products.back' => 'Natrag na popis',

    // Gallery
    'gallery.prev' => 'Prethodno',
    'gallery.next' => 'Sljedeće',

    // Home page
    'home.title' => 'Početna stranica',
    'home.lead' => 'Dobrodošli u Kabi Test! Ovdje možete pronaći sve naše proizvode i informacije o nama.',

    // About / Contact / Write to us
    'about.title' => 'O nama',
    'about.lead' => 'Kratak opis tvrtke/tima. Ovdje možete sažeti iskustvo i fokus.',
    'contact.title' => 'Kontakt',
    'contact.email' => 'E-pošta',
    'contact.phone' => 'Telefon',
    'contact.address' => 'Adresa',
    'write.title' => 'Pišite nam',
    'form.name' => 'Ime',
    'form.email' => 'E-pošta',
    'form.message' => 'Poruka',
    'form.send' => 'Pošalji',
    ...
    // Products
    // Headphones
    'product.headphones.name' => 'Bežične slušalice',
    'product.headphones.category' => 'Audio oprema',
    'product.headphones.short' => 'Impresivan zvuk s aktivnim poništavanjem buke.',
    'product.headphones.description' => 'Visokokvalitetne bežične slušalice s naprednom tehnologijom poništavanja buke, dubokim basom i do 30 sati trajanja baterije. Savršene za putovanja, rad i svakodnevno slušanje.',
